...
<nav class="navbar navbar-light navbar-expand-md bg-light">
    <a href="/" class="navbar-brand">Prediction</a>
...
<iframe style="height: -webkit-fill-available;"width="100%" src="/predict?r_id=<%=id%>&type=<%=type %>"></iframe>
    </div>
        <div class="col-md-2 order-md-1 pt-3">
            <div class="bg-faded mb-3">
                <h5 class="card-header">List of things</h5>
                <div class="card-body">
<a href="/predicts?r_id=<%=id %>&type=1"> Bar</a>,
             <a href="/predicts?r_id=<%=id %>&type=2"> AreaChart</a>,
             <a href="/predicts?r_id=<%=id %>&type=3"> Bubble</a>,
             <a href="/predicts?r_id=<%=id %>&type=4"> Scatter</a>,
             <a href="/predicts?r_id=<%=id %>&type=5"> Histrogram</a>,
             <a href="/predicts?r_id=<%=id %>&type=6"> Column</a>,
             <a href="/predicts?r_id=<%=id %>&type=7"> Pie</a>,
             <a href="/predicts?r_id=<%=id %>&type=8"> Donut</a>
                </div>
            </div>
        </div>
    </div>
